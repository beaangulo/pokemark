...
var button = document.querySelector('.borgor');
var menu = document.querySelector('.menu');
var dragonite1 = document.getElementById('dragonite1');
var logo = document.getElementById('pokemarklogo');
var markonite = document.getElementById('markonite');
var ludimarko = document.getElementById('ludimarko');
var charkey = document.getElementById('charkey');
var fuemarko = document.getElementById('fuemarko');
var marklup = document.getElementById('marklup');
var marklet = document.getElementById('marklet');
var dexpic = document.getElementById('dexpic');
